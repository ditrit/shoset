...
func TestDeleteConfig(t *testing.T) {
	...
	shoset.ConnsByLname.DeleteConfig("test", "127.0.0.1:9003")
	shoset.ConnsByLname.DeleteConfig("test", "127.0.0.1:9004")

	syncMap, _ := shoset.ConnsByLname.Load("test")
	if LenSyncMap(syncMap.(*sync.Map)) != 2 {
		t.Errorf("DeleteConfig didn't work")
	}
}
